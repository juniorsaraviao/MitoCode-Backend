...
namespace MitoCodeExam.DataAccess
{
   public static class DbContextExtensions
   {
      ...
      public static async Task UpdateEntity<TRequest>(this DbContext context, TRequest entity)
         where TRequest : EntityBase
      {
      ...
      public static async Task Delete<TRequest>(this DbContext context, TRequest entity)
         where TRequest : EntityBase
      {
         var entidad = await context.Set<TRequest>().FirstOrDefaultAsync(x => x.Id == entity.Id );
